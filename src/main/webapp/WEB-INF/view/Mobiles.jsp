...
app.controller('productCtrl', function($scope) {
	$scope.products=${listmo}	
   
});
</script>
<title>Insert title here</title>
</head>
<body ng-app="myApp" ng-controller="productCtrl" style="background-image: url(resources/images/bb9.jpg);margin-bottom:120px; background-repeat:no-repeat;height:100%;background-position:center;background-size:cover; ">
...
<br>
<div class="tr-container container">    
  <div class=" tr-row row">
